...
//    }
        ...
        GenerateFromComputer generator = new GenerateFromComputer(Difficulte.MOYEN);
        ClassicSudokuGrid<Integer> sudokuGrid = new ClassicSudokuGrid<>(9, possibleValues);

        System.out.println("🔹 Génération d'une grille complète...");
        generator.GeneratePuzzle(sudokuGrid, Difficulte.MOYEN);
